...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (localStorageSession) { document.getElementById('userCarId').innerHTML = localStorageSession }
  ...
  (async () => {
      ...
      .then(data => {
        if (data === 'userNotFound') {
          ...
          data.forEach(item => {
            ...
            deleteIcon.setAttribute('class', 'delete product__icon fa fa-trash')
    ...
    document.querySelectorAll('.product').forEach(item => item.addEventListener('click', (e) => {
